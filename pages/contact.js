        ...
        <div className="m-2 flex items-center justify-center h-full">
            <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-1 w-full">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-3 w-full text-center">
                    <Link href="" target='_blank' className="bg-white shadow-lg rounded-lg p-6 text-center justify-center hover:text-white hover:bg-navyGreen">
                    ...
                    <Link href="https://calendly.com/madison-landlocket/30min" target='_blank' className="bg-white shadow-lg rounded-lg p-6 text-center justify-center justify-center hover:text-white hover:bg-navyGreen">
